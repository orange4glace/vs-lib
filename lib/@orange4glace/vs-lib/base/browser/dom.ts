...
import * as browser from '@orange4glace/vs-lib/base/browser/browser';
import { domEvent } from '@orange4glace/vs-lib/base/browser/event';
import { IKeyboardEvent, StandardKeyboardEvent } from '@orange4glace/vs-lib/base/browser/keyboardEvent';
import { IMouseEvent, StandardMouseEvent } from '@orange4glace/vs-lib/base/browser/mouseEvent';
import { TimeoutTimer } from '@orange4glace/vs-lib/base/common/async';
import { onUnexpectedError } from '@orange4glace/vs-lib/base/common/errors';
import { Emitter, Event } from '@orange4glace/vs-lib/base/common/event';
import { Disposable, DisposableStore, IDisposable, toDisposable } from '@orange4glace/vs-lib/base/common/lifecycle';
import * as platform from '@orange4glace/vs-lib/base/common/platform';
import { URI } from '@orange4glace/vs-lib/base/common/uri';
import { FileAccess, RemoteAuthorities } from '@orange4glace/vs-lib/base/common/network';
import { BrowserFeatures } from '@orange4glace/vs-lib/base/browser/canIUse';
import { insane, InsaneOptions } from '@orange4glace/vs-lib/base/common/insane/insane';
import { KeyCode } from '@orange4glace/vs-lib/base/common/keyCodes';
import { withNullAsUndefined } from '@orange4glace/vs-lib/base/common/types';
...
const _ttpSafeInnerHtml = (window as any).trustedTypes?.createPolicy('safeInnerHtml', {
