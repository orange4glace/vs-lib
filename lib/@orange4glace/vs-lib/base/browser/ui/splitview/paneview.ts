...
import './paneview.css';
import { IDisposable, Disposable, DisposableStore } from '@orange4glace/vs-lib/base/common/lifecycle';
...
import { StandardKeyboardEvent } from '@orange4glace/vs-lib/base/browser/keyboardEvent';
import { KeyCode } from '@orange4glace/vs-lib/base/common/keyCodes';
import { $, append, trackFocus, EventHelper, clearNode } from '@orange4glace/vs-lib/base/browser/dom';
import { Color, RGBA } from '@orange4glace/vs-lib/base/common/color';
import { SplitView, IView } from './splitview';
import { isFirefox } from '@orange4glace/vs-lib/base/browser/browser';
import { DataTransfers } from '@orange4glace/vs-lib/base/browser/dnd';
import { Orientation } from '@orange4glace/vs-lib/base/browser/ui/sash/sash';
import { ScrollEvent } from '@orange4glace/vs-lib/base/common/scrollable';
