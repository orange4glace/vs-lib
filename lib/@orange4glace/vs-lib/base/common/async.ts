...
import { CancellationToken, CancellationTokenSource } from '@orange4glace/vs-lib/base/common/cancellation';
import * as errors from '@orange4glace/vs-lib/base/common/errors';
import { Emitter, Event } from '@orange4glace/vs-lib/base/common/event';
import { IDisposable, toDisposable } from '@orange4glace/vs-lib/base/common/lifecycle';
...
export function raceTimeout<T>(promise: Promise<T>, timeout: number, onTimeout?: () => void): Promise<T> {
	...
	return Promise.race([
		...
		new Promise<T>(resolve => (promiseResolve as any) = resolve)
	]);
}
